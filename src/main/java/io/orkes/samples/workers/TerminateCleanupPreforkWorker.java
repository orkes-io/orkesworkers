...
public class TerminateCleanupPreforkWorker {
  ...
  public Map<String, Object> executeTerminateCleanupPrefork(
      @ToolParam(description = "Input parameters for termination and cleanup")
          TerminateCleanupPreforkInput input) {
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to execute terminate cleanup prefork: " + e.getMessage(), e);
    }
