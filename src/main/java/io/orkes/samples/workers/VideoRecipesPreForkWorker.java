...
public class VideoRecipesPreForkWorker {
  ...
  public Map<String, Object> executeVideoRecipesPreFork(
      @ToolParam(description = "Input parameters for video recipe processing")
          VideoRecipesPreForkInput input) {
    ...
    try {
      ...
      for (String fileLocation : fileLocations) {
        for (Map<String, Object> recipeInfo : recipeInfos) {
          ...
          Map<String, Object> recipeParameters =
              (Map<String, Object>) recipeInfo.get("recipeParameters");
