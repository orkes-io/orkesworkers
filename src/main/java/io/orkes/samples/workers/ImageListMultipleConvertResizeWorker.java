...
public class ImageListMultipleConvertResizeWorker {
  ...
  @Tool(
      description =
          "Creates dynamic tasks for converting and resizing multiple images to various formats and sizes")
  public Map<String, Object> imageListMultipleConvertResize(
      @ToolParam(description = "Input parameters for multiple image conversions")
          ImageListConversionInput input) {
