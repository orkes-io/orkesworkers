...
public class ImageConvertResizeWorker {
  ...
  public Map<String, Object> imageConvertResize(
      @ToolParam(description = "Input parameters for image conversion")
          ImageConversionInput input) {
  ...
  private void resizeImage(String inputImage, Integer width, Integer height, String outputImage)
      throws Exception {
  ...
  private void sepia(String inputImage, Double sepiaIntensityThreshold, String outputImage)
      throws Exception {
    ConvertCmd cmd = new ConvertCmd();
