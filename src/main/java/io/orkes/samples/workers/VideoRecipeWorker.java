...
public class VideoRecipeWorker {
  ...
  public Map<String, Object> executeVideoRecipe(
    ...
    try {
      ...
      String fileExtension =
          !Strings.isNullOrEmpty(outputFileFormat)
              ? outputFileFormat
              : Files.getFileExtension(fileLocation);
      ...
      if (recipe == VIDEO_RECIPE.WATERMARK) {
        ...
        Integer audioSamplingFrequency =
            tryParseInteger(recipeParameters, "audioSamplingFrequency");
  ...
  public void watermark(
      String inputFileLocation, String watermarkFileLocation, String outputFileLocation)
      throws Exception {
